          ...
          postFlinkUrl(){
            ...
            addNode(evt, nodeMenu, mousePosition) {
                ...
                var node = {
                    ...
                    //数据源
                    state: '',//数据源类型
                    dataResourceDingyi:'',//数据结构定义
                    dataResourceZhouqiState:'',//数据源周期类型
                    //jdbc
                    jdbc_DBUrl:'',
                    jdbc_userName:'',
                    jdbc_tableName:'',
            ...
            //上传数据流程图json到服务器
            graphPost(){
              request.post("/graphJson",JSON.stringify(this.data).toString()).then((res)=>{
                  console.log(res)
              });
            },
            //用户自定义类
...
<style scoped>
#efContainer >>> svg.jtk-connector path:nth-child(2) {
    stroke: #38BDF8;
}
#efContainer >>> svg.jtk-connector path:nth-child(3) {
    stroke: #38BDF8;
    fill: #38BDF8;
}
#efContainer {
